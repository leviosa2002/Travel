...
export default function PlacePage() {
  ...
  const loadPlaceData = async () => {
    ...
    try {
      ...
      // Load place details
      const placeData = await wikipediaAPI.getPlaceDetails(title);
      if (placeData) {
        setPlace({
          ...placeData,
          fullText: placeData.extract,
          sections: [],
          type: 'attraction'
        });

        // Load coordinates if not available
        let coords = placeData.coordinates;
        if (!coords) {
                  ...
                  <div>
                    ...
                    {place.coordinates && (
                      <div className="flex items-center text-white/90 text-lg">
                        ...
                        <span>{coordinates ? `${coordinates.lat.toFixed(4)}, ${coordinates.lon.toFixed(4)}` : 'Location'}</span>
                      </div>
                    )}
                  </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Description */}
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">About {place.title}</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-gray-700 mb-2">Best Time to Visit</h4>
                  <p className="text-sm text-gray-600">
                    This destination can be enjoyed year-round, but spring and fall typically offer the most pleasant weather.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Plan to spend 2-4 hours exploring this destination thoroughly.
                  </p>
                </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center justify-center space-x-2 bg-gray-50 hover:bg-gray-100 py-3 rounded-lg transition-colors">
                ...
                <button
                  onClick={() => router.push(`/reviews/${place.id}`)}
                  className="w-full flex items-center justify-center space-x-2 bg-gray-50 hover:bg-gray-100 py-3 rounded-lg transition-colors"
                >
